...
describe("Appointment", () => {
  ...
  it("renders other presentation notes notes", () => {
    render(
      <Appointment
        customer={blankCustomer}
        notes="def"
  ...
  it("renders the time as the heading", () => {
    ...
    ).toEqual("Today’s presentation at 09:00");
  });
});

describe("PresentationDayView", () => {
  const today = new Date();
  ...
  it("renders a div with the right id", () => {
    render(<PresentationDayView appointments={[]} />);
    expect(
      document.querySelector(
        "div#presentationDayView"
      )
    ).not.toBeNull();
  });
